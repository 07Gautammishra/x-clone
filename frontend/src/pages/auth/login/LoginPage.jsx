	...
	return (
		<div className='max-w-screen-xl mx-auto flex h-screen'>
			...
			<div className='flex-1 flex flex-col justify-center items-center'>
				<form className='lg:w-5/6  mx-auto md:mx-20 flex gap-4 flex-col' onSubmit={handleSubmit}>
					...
					<label className='input input-bordered rounded flex items-center gap-2'>
						...
						/>
						<span onClick={() => setShowOrNot(!showOrNot)}>
							{showOrNot ? <FaEyeSlash /> : <FaEye />}
						</span>
					</label>
				...
				<div className='flex flex-col lg:w-5/6 md:mx-24 gap-2 mt-4'>
